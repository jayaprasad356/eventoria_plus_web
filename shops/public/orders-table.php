                        ...
                        <table id='users_table' class="table table-hover" data-toggle="table" data-url="get-bootstrap-table-data.php?table=vendor_orders" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-show-footer="true" data-filter-control="true" data-query-params="queryParams" data-sort-name="id" data-sort-order="desc" data-show-export="true" data-export-types='["txt","excel"]' data-export-options='{
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="total_price" data-sortable="true" data-footer-formatter="priceFormatter">Total Price</th>
